  ...
  function ColorExtractor() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.processImage = function () {
      ...
      if (props.children) {
        ...
        // $FlowFixMe
        _this.parseImage(props.children.props.src, props);
      } else if (props.src && typeof props.src === "string" && props.src.length > 0) {
        // if the image is provided via src prop
        _this.parseImage(props.src, props);
      }
    }, _this.parseImage = function (image, props) {
      Vibrant.from(image).getSwatches().then(function (swatches) {
...
var rgbToHex = Vibrant.Util.rgbToHex;
// Convert HEX to RGB
var hexToRgb = Vibrant.Util.hexToRgb;
// Convert RGB to HSL
var rgbToHsl = Vibrant.Util.rgbToHsl;
// Convert HSL to RGB
var hslToRgb = Vibrant.Util.hslToRgb;
